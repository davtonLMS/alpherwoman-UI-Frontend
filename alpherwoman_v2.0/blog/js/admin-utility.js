var pop = document.querySelectorAll(".popout")
for (let i = 0; i < pop.length; i++) {
    const e = pop[i];
    e.addEventListener("mouseover", function () {
        e.querySelector(".pop").classList.remove("d-none")
    })

    e.addEventListener("mouseout", function () {
        e.querySelector(".pop").classList.add("d-none")
    })
}

function closeNotif() {
    var ul = document.getElementById("notification")
    var li = ul.querySelectorAll("p.small.text-muted")
...
function homePageOnly(){
        ...
        var datetime = hours + ":"  
                    ...
                    $(".chat-sidebar").prepend('\
                                                <div class="background-muted message_detail cursor active_message" id="'+id+'" >\
                            ...
                            <div class="col-md-12 my-2 pt-2">
                                <div class="px-4 row">
                                    <div class="col-9 d-flex">
                                        <div class="mr-2">
                                            <img src="./blog/images/course_img.png" class="mt-1 avatar-img">
                                        </div>
                        ...
                        <div class="col-12 blog_comment reply-item pt-1 px-4" data-reply-id="1" style="display:block">
                            <div class="row main-comment">
                                <div class="col-1 px-1">
                                    <img src="`+img+`" class="mt-1" style="width:25px; height:25px; border-radius:50%" />
                                </div>
...
img = './blog/images/course_img.png' // Will be a global value
        ...
        $(section).append(`
            <div class="px-4 row my-3">
                <div class="col-lg-12 col-12 d-flex lead emoji-picker-container px-1">
                    <img src="`+img+`" class="mt-1 mr-2 avatar-img" />
    ...
    if (comment != "") {
            $(section).after(`
                ...
                <div class="col-12 blog_comment reply-item pt-1 px-4" data-reply-id="`+time+`" style="display:block">
                    <div class="row main-comment">
                        <div class="col-1 px-1">
                            <img src="`+img+`" class="mt-1 avatar-imgg" />
                        </div>
                        <div class="col-11 p-2 position-relative info cursor">
                            <p class="weight-semi-bold mb-1" id="comment-name"> `+name+` <span class="font-12 float-right font-weight-400">`+since+`</span></p>
...
$("body").delegate(".add-reply-comments", "click", function(e){
    ...
    $(this).closest('.main-comment').append(`
        <div class="row lead emoji-picker-container mb-3 w-100 pl-4">
            <div class="col-1 px-1">
                <img src="./blog/images/course_img.png" class="mt-1" style="width:25px; height:25px; border-radius:50%" />
            </div>
            <div class="col-9 px-0">
                <input type="text" placeholder="Add a reply" class="form-control mt-2 comment-text example`+time+`" id="input-comment-1" />
            </div>
